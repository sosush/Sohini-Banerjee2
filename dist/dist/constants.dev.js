...
var react_1 = require("react"); // fix: Corrected icon assignments to use React.createElement
...
exports.ANIMATED_TITLES = ["Student Full-Stack Developer", "Cybersecurity Enthusiast", "Problem Solver", "AI ML Engineer", "API Specialist"];
...
exports.skillsData = [// fix: Changed JSX to React.createElement for icon definition
{
  name: "Python",
  category: "Languages",
  icon: react_1["default"].createElement(icons_1.LanguageIcon, {
...
}, // fix: Changed JSX to React.createElement for icon definition
{
  ...
  icon: react_1["default"].createElement(icons_1.ServerIcon, {
    className: "w-6 h-6 mr-2 text-purple-400"
  }),
  proficiency: 80
}, // fix: Changed JSX to React.createElement for icon definition
...
}, // fix: Changed JSX to React.createElement for icon definition
{
  name: "SQL",
  category: "Databases",
  icon: react_1["default"].createElement(icons_1.DatabaseIcon, {
    className: "w-6 h-6 mr-2 text-purple-400"
  }),
  proficiency: 90
}, // fix: Changed JSX to React.createElement for icon definition
...
// fix: Changed JSX to React.createElement for icon definition
{
  ...
  icon: react_1["default"].createElement(icons_1.ToolsIcon, {
    className: "w-6 h-6 mr-2 text-purple-400"
  }),
  proficiency: 60
}, // fix: Changed JSX to React.createElement for icon definition
...
// fix: Changed JSX to React.createElement for icon definition
{
  name: "Git & GitHub",
  category: "Tools & Platforms",
  icon: react_1["default"].createElement(icons_1.GithubIcon, {
    className: "w-6 h-6 mr-2 text-purple-400"
  }),
  proficiency: 98
}, // fix: Changed JSX to React.createElement for icon definition
{
  name: "Microservices",
  category: "Other",
  icon: react_1["default"].createElement(icons_1.CodeIcon, {
    className: "w-6 h-6 mr-2 text-purple-400"
  }),
  proficiency: 90
}, // fix: Changed JSX to React.createElement for icon definition
...
exports.socialLinksData = [// fix: Changed JSX to React.createElement for icon definition
{
  name: "GitHub",
  url: "https://github.com/2S00B5",
  icon: react_1["default"].createElement(icons_1.GithubIcon, {
    className: "w-6 h-6"
  })
}, // fix: Changed JSX to React.createElement for icon definition
{
  name: "LinkedIn",
  url: "https://www.linkedin.com/in/sohini-banerjee-12882731b/",
  icon: react_1["default"].createElement(icons_1.LinkedinIcon, {
    className: "w-6 h-6"
  })
}, // fix: Changed JSX to React.createElement for icon definition, changed Twitter to Instagram
{
  name: "Instagram",
  url: "https://www.instagram.com/_sosush_/",
  icon: react_1["default"].createElement(icons_1.InstagramIcon, {
    className: "w-6 h-6"
  })
}, // fix: Changed JSX to React.createElement for icon definition
{
  name: "Email",
  url: "mailto:" + exports.CONTACT_EMAIL,
  icon: react_1["default"].createElement(icons_1.EmailIcon, {
    className: "w-6 h-6"
  })
}];
